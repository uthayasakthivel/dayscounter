...
const App = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen text-[1.2rem] leading-[1.8rem] bg-white bg-[linear-gradient(315deg,#ffffff_0%,#335c81_74%)]'>
      ...
      <input className='text-[whitesmoke] cursor-pointer m-4 p-2 box-content border border-gray-300 rounded-md"'
        type="date"
        id="userDateInput"
        value={userDate}
        onChange={handleDateChange}
        style={{ background: 'radial-gradient(black, transparent)', colorScheme: 'dark' }}
      />
